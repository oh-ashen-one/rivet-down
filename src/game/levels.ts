...
function pattern(
  ...
  if (name === "steps") {
    ...
    push("pad", 7.25);
    push("block", 11, { height: 110 + intensity * 6 });
    push("spike", 13);
    push("spike", 14);
  }
  ...
  if (name === "crusher") {
    ...
    push("block", 2.2, { lane: "floor", height: 220 });
    push("block", 4.4, { lane: "ceiling", height: 260 });
    push("orb", 5.4, { y: 420 });
    push("gap", 5.8, { widthBeats: 2.4 });
    push("block", 8.5, { lane: "floor", height: 255 });
